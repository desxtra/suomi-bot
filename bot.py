...
async def on_ready():
    ...
    try:
        ...
        if char_token:
            ...
            print('Character.AI client initialized and authenticated successfully!')
        else:
...
async def slash_reset(interaction: discord.Interaction):
    ...
    if user_id in user_chats:
        ...
        await interaction.response.send_message("ℹ️ You don't have an active conversation to reset.")
